...
export class AuthService {
    ...
    public logIn() {
        let loginUrl = "https://login.microsoftonline.com/" + SvcConsts.TENANT_ID +
    ...
    private tokenPromise = (endpoint: string): Promise<string> => {
        let p = new Promise<string>((resolve: Function, reject: Function) => {
            ...
            if (token && token !== "undefined") {
                ...
                this.getAccessToken().then(result => {resolve(result)}).catch(err => {reject(err);});
            }
        });
        return p;
    };
    ...
    private getAccessToken() {
        let p = new Promise<string>((resolve: Function, reject: Function) => {
            ...
            let accessUrl = "https://login.microsoftonline.com/" + SvcConsts.TENANT_ID +
